...
public enum VersionEnums {
	...
	VERSION_18(0), // version 1.8 (only here to disallow plugin being enabled)
	...
	VERSION_116(8), // version 1.16 (only here to disallow plugin being enabled until I have support)
