...
public class MessageManager {
	 ...
	 * 
	 * private HashMap<EntityType, List<String>> messages = new HashMap<EntityType,
	 * List<String>>();
	 * 
	 * public MessageManager(CustomDeathMessages plugin) { this.plugin = plugin;
	 * 
	 * for (EntityType entity : entities) { messages.put(entity,
	 * plugin.getConfig().getStringList(Paths.valueOf(entity.toString()).getPath()))
	 * ; } }
	 * 
	 * public String getMessage(EntityType messageType) { Random rand = new
	 * Random(); String msg =
	 * messages.get(messageType).get(rand.nextInt(messages.size()));
	 * 
