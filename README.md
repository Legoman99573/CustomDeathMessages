...
#To use hex colors: #<HEX CODE> Use it like a &[color] sign, place it in front of messages or words, etc.
#PvP Messages only for when  a player is killed by another player, enabled by default
#Placeholders for pvp messages: %victim%, %victim-nick%, %killer%, %killer-nick%
enable-pvp-messages: true
killer-message: '&e[&cDeathMessages&e] &eYou have killed &c%victim%'
...
#Heart Sucker: resets the players health to 20 when they kill another player.
#Give Killer Speed: gives the player a customizable level of speed for a customizable amount seconds when they kill another player.
...
give-killer-speed: false
speed-level: 1
speed-length-seconds: 5
...
#Placeholders for melee messages: %victim%, %victim-nick%, %killer%, %killer-nick%, %kill-weapon%
global-pvp-death-messages:
   - "&c%victim% &ehas been killed by &c%killer%"
    - "&c%victim% &ewas slain by &c%killer% &eusing [&b%kill-weapon%&e]"
    - "&c%victim% &ehas been put down by &c%killer%"
    - "&c%victim% &ewas slaughtered by &c%killer% &eusing [&b%kill-weapon%&e]"
    - "&c%killer% &epulverized &c%victim% &eusing [&b%kill-weapon%&e]"
    - "&c%victim% &ewas destroyed by &c%killer%&e"
    - "&c%killer% &egave &c%victim% &ethe L"
    - "&c%victim% &ewas EZ clapped by &c%killer% &eusing [&b%kill-weapon%&e]"

#Placeholders for melee messages: %victim%, %victim-nick%, %killer%, %killer-nick%
melee-death-messages:
   - "&c%victim% &ewas slapped by &c%killer%"
    - "&c%victim% &ewas KO'd &c%killer%"
    - "&c%victim% &egot rocked by &c%killer%"
 
#Placeholders for ALL below messages: %victim%, %victim-nick%
